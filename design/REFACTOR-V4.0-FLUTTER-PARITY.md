...
- **CoordinateConverterV4:** Central utility for Flutter Forge2D → Godot pixel conversion.
...
- **MainV4._apply_camera_status():** Fixed center (400, 300), visible height 650. Flutter formulas (zoom/pos per status) produced off-screen views; Godot uses single centered view so flippers, launcher, ramp, zones are all visible.
